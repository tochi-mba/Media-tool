...
One middleware, doing three things that all belong to the same span: give the request an
id, make that id visible to every log record it produces, and record how long it took.
"""
...
from media_tool.api.errors import unhandled_problem_response
from media_tool.core.context import bind_request_id, new_request_id
